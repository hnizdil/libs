 ...
 * @author Jan Hnízdil <hnizdil@gmail.com>
 */
class ClassLoader
{
	...
	public function loadClass($className)
	{
		...
		$ns = $this->_namespace . $this->_namespaceSeparator;

		if (!$this->_namespace || $ns === substr($className, 0, strlen($ns))) {

			$fileName = '';

			if ($this->_includePath) {
				$fileName .= $this->_includePath . DIRECTORY_SEPARATOR;
			}
